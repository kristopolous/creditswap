  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
      <div className="rounded-2xl border border-gray-800/50 bg-gray-900/60 backdrop-blur-xl p-8 sm:p-12">
        ...
        <div className="mt-10 space-y-10">
          <section>
            <div className="flex items-center gap-4">
              <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-brand-500/10 text-lg font-bold text-brand-400">1</span>
              <div>
          ...
          <section>
            <div className="flex items-center gap-4">
              <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-brand-500/10 text-lg font-bold text-brand-400">2</span>
              <div>
          ...
          <section>
            <div className="flex items-center gap-4">
              <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-brand-500/10 text-lg font-bold text-brand-400">3</span>
              <div>
                ...
                <div className="mt-3 rounded-xl bg-gray-950 border border-gray-800 p-4">
          ...
          <section>
            <div className="flex items-center gap-4">
              <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-brand-500/10 text-lg font-bold text-brand-400">4</span>
              <div>
          ...
          <section>
            <div className="flex items-center gap-4">
              <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-brand-500/10 text-lg font-bold text-brand-400">5</span>
              <div>
        ...
        <div className="mt-10 rounded-xl bg-gradient-to-br from-brand-500/10 to-brand-500/5 border border-brand-500/20 p-5">
