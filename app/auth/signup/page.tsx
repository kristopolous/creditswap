    ...
    return (
      <div className="flex min-h-[calc(100vh-200px)] items-center justify-center py-16">
        <div className="w-full max-w-sm text-center">
          <div className="rounded-2xl border border-gray-800/50 bg-gray-900/60 backdrop-blur-xl p-8">
  ...
  return (
    <div className="flex min-h-[calc(100vh-200px)] items-center justify-center py-16">
      <div className="w-full max-w-sm">
        <div className="rounded-2xl border border-gray-800/50 bg-gray-900/60 backdrop-blur-xl p-8 text-center">
