        ...
        {open && (
          <>
            ...
            <div className="absolute right-0 z-50 mt-2 w-56 rounded-2xl border border-gray-800/50 bg-gray-900/95 backdrop-blur-xl p-2 shadow-xl">
              ...
              <a href="/dashboard" className="flex w-full items-center gap-2 rounded-xl px-3 py-2 text-sm text-gray-400 hover:text-white hover:bg-gray-800/50 transition-colors">
              ...
              <a href="/dashboard/bought" className="flex w-full items-center gap-2 rounded-xl px-3 py-2 text-sm text-gray-400 hover:text-white hover:bg-gray-800/50 transition-colors">
                <span className="text-base">📥</span> Credits Bought
              </a>
              <a href="/dashboard/sold" className="flex w-full items-center gap-2 rounded-xl px-3 py-2 text-sm text-gray-400 hover:text-white hover:bg-gray-800/50 transition-colors">
                <span className="text-base">📤</span> Credits for Sale
              </a>
              <a href="/dashboard/settings" className="flex w-full items-center gap-2 rounded-xl px-3 py-2 text-sm text-gray-400 hover:text-white hover:bg-gray-800/50 transition-colors">
